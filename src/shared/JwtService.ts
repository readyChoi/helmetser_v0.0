...
export class JwtService {
    ...
    private readonly refreshOptions: IOptions;
    ...
    constructor() {
        ...
        this.refreshOptions = {expiresIn: "14d"};
    }
    ...
    public getRefreshJwt():Promise<string> {
        return new Promise((resolve, reject) => {
            jsonwebtoken.sign({}, this.secret, this.refreshOptions, (err, token) => {
                err ? reject(err) : resolve(token || '');
            })
        })
    }

    public refreshVerify(): any {
